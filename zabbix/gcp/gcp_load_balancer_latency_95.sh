...
# Zabbix server.
zabbix_server="glu-zabbix-proxy-1"
# Host name, which is being monitored in Zabbix.
host="GluPlay DashTown GCP"
# Custom location of gcpmetrics.
gcpmetrics="python /Users/dimitriy.alekseyev/github/gcpmetrics/gcpmetrics/gcpmetrics.py"
#gcpmetrics="python27 /etc/zabbix/externalscripts/gcpmetrics/gcpmetrics.py"
...
# Aggregation.
aggregation="--align ALIGN_PERCENTILE_95 --reduce REDUCE_PERCENTILE_95 --reduce-grouping metric.label.response_code_class,resource.label.$resource_key"
